  ...
  return (
    <div className="bg-[#B7B7B7] min-h-screen w-full">
      <div className="min-h-60 bg-gradient-to-r from-[#B31312] to-[#FF7676]">
        <h1 className="text-3xl font-bold text-[#FCF5ED] flex justify-start pl-10 pt-10">Welcome to Professor Roll</h1>
      ...
      <div className="flex justify-start ">
        ...
        <div className="absolute bg-gradient-to-r from-black border-[5px] border-black  w-[100%] h-[600px] z-10">
          <p className="absolute pl-3 pt-4 text-white z-3 max-w-[50%] font-bold text-xl">Welcome to Prof. Roll!</p>
          <p className="absolute pl-3 pt-[70px] text-white z-3 max-w-[800px] text-left text-lg">
